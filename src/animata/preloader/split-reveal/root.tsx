...
export function SplitRevealRoot({
  ...
  return (
    <SplitRevealContext.Provider value={contextValue}>
      <SplitRevealInternalContext.Provider value={internalValue}>
        {children}
      </SplitRevealInternalContext.Provider>
    </SplitRevealContext.Provider>
  );
}
